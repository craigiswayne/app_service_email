...
class App_service_email {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      App_service_email_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - App_service_email_Loader. Orchestrates the hooks of the plugin.
	 * - App_service_email_i18n. Defines internationalization functionality.
	 * - App_service_email_Admin. Defines all hooks for the admin area.
	 * - App_service_email_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the App_service_email_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
